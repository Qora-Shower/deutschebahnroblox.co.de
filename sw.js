const CACHE_NAME = 'Deutsche-Bahn-Roblox-v6';
...
self.addEventListener('install', event => {
  event.waitUntil(caches.open(CACHE_NAME).then(cache => {
    return cache.addAll([
      ...
      BASE + 'auth-ui/loginWindow.html',
      BASE + 'auth-ui/signInWindow.html',
      BASE + 'auth-ui/css/loginWindow.css',
      BASE + 'auth-ui/css/signInWindow.css',
      BASE + 'install.js',
      BASE + 'manifest.json',
      BASE + 'icon2-512.png',
      BASE + 'icon512.png',
